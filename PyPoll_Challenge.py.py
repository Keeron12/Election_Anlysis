...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_vote:
        ...
        vote_for_county = county_vote[county_name]
        # 6c: Calculate the percentage of votes for the county.
        vote_for_county_percentage = float(vote_for_county) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        county_results = f"{county_name}: {vote_for_county_percentage:.1f}% ({vote_for_county:,})\n"
        print(county_results)
         # 6e: Save the county votes to a text file.
        txt_file.write(county_results)
         # 6f: Write an if statement to determine the winning county and get its vote count.
    if (vote_for_county > winning_count) and (vote_for_county_percentage > winning_percentage):
        
        largest_county = county_name

        county_voter_turnout = county_vote[county_name]
    ...
    f"Voter turnout: {county_voter_turnout}\n"

    f"Percentage Turnout: {vote_for_county_percentage:.1f}%\n"
